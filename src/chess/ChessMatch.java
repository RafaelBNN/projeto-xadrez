...
public class ChessMatch {
    ...
    public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition){
        ...
        if(testCheck(currentPlayer)){
            ...
            throw new ChessException("Error in movement: this move puts your king in check");
        }
    ...
    private boolean testCheckMate(Color color){
        ...
        List<Piece> friendlyPieces = piecesOnTheBoard.stream().filter(x -> ((ChessPiece)x).getColor() == (color)).collect(Collectors.toList());
        ...
        return ((!king(color).isThereAnyPossibleMove()));
    }
